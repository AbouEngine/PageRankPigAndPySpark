...
INIT = Pig.compile("""
A = LOAD 'gs://abou_bucket/public_lddm_data/page_links_en.nt.bz2' using PigStorage(' ') as (url:chararray, p:chararray, link:chararray);
B = GROUP A by url;                                                                                  
...
params = { 'd': '0.5', 'docs_in': 'gs://abou_bucket/out/pagerank_page_links' }
